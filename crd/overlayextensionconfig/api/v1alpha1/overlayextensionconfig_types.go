...
// OverlayExtensionConfigSpec defines the desired state of OverlayExtensionConfig. ExtensionIPRange field defines a CIDR that should be able to reach routing domain ip addresses.
